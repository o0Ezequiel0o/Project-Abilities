...
{
    public class LifeCrystalItem : Item
    {
        public override ItemData Data => data;
        private readonly LifeCrystalItemData data;
        ...
        public LifeCrystalItem(LifeCrystalItemData data, ItemHandler itemHandler, GameObject source)
        {
            this.data = data;
            this.source = source;
