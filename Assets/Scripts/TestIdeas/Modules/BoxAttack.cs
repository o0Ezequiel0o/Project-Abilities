...
namespace Zeke.Abilities.Modules
{
    ...
    public class BoxAttack : AbilityModule
    {
        ...
        public override AbilityModule CreateDeepCopy() => new BoxAttack(this);
        ...
        protected virtual void OnDamageDealt(GameObject source, ModularAbilityController controller, Collider2D hit) { }
