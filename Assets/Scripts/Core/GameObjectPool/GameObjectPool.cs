...
public class GameObjectPool
{
    ...
    public GameObject Get()
    {
        ...
        {
            if (poolableGameObjects[i].ReadyToRetrieve())
            {
                poolableGameObjects[i].OnPoolableGet();
...
public class GameObjectPool<T> where T : Component
{
    ...
    public T Get()
    {
        for (int i = 0; i < poolableGameObjects.Count; i++)
        {
            if (poolableGameObjects[i].poolableGameObject.ReadyToRetrieve())
            {
                poolableGameObjects[i].poolableGameObject.OnPoolableGet();
    ...
    public void Clear()
    {
        for (int i = 0; i < poolableGameObjects.Count; i++)
        {
            ...
            GameObject.Destroy(poolableGameObjects[i].poolableGameObject.gameObject);
        }
        poolableGameObjects.Clear();
    }
